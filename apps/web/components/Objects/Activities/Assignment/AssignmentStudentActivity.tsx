...
import TaskFileObject from '@/app/[locale]/orgs/[orgslug]/dash/assignments/[assignmentuuid]/_components/TaskEditor/Subs/TaskTypes/TaskFileObject';
import TaskQuizObject from '@/app/[locale]/orgs/[orgslug]/dash/assignments/[assignmentuuid]/_components/TaskEditor/Subs/TaskTypes/TaskQuizObject'
import TaskFormObject from '@/app/[locale]/orgs/[orgslug]/dash/assignments/[assignmentuuid]/_components/TaskEditor/Subs/TaskTypes/TaskFormObject'
...
function AssignmentStudentActivity() {
  const t = useTranslations('assignments.student')
      ...
      <div className='flex flex-col md:flex-row justify-center md:space-x-3 space-y-3 md:space-y-0 items-center'>
        <div className='text-xs h-fit flex space-x-3 items-center'>
          <div className='flex gap-2 py-2 px-4 md:px-5 h-fit text-sm text-slate-700 bg-slate-100/5 rounded-full nice-shadow items-center'>
            ...
            <p className='font-semibold'>{tAssignments('assignment')}</p>
          </div>
        </div>
        <div>
          <div className='flex gap-2 items-center'>
            ...
            <div className='flex gap-2 items-center'>
              <div className='flex gap-1 md:space-x-2 text-xs items-center text-slate-400'>
                <Calendar size={14} />
                <p className='font-semibold'>{tAssignments('dueDate')}</p>
        ...
        <div className='flex flex-col space-y-2 p-4 md:p-6 bg-slate-100/30 rounded-md nice-shadow'>
          <div className='flex flex-col space-y-3'>
            <div className='flex items-center gap-2 text-slate-700'>
              ...
              <h3 className='text-sm font-semibold'>{tAssignments('assignmentDescription')}</h3>
            </div>
            <div className='pl-6'>
