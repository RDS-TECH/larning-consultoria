...
function UserGroupsSection({ usergroups }: { usergroups: any[] }) {
    ...
    return (
        <>
            <div className="flex flex-col bg-gray-50 -space-y-1 px-3 sm:px-5 py-3 rounded-md mb-3">
                <h1 className="font-bold text-lg sm:text-xl text-gray-800">{t('userGroups')}</h1>
                <h2 className="text-gray-500 text-xs sm:text-sm">
                    {t('userGroupsDescription')}
                </h2>
            </div>
                        ...
                        {usergroups?.map((usergroup: any) => (
                            <tr key={usergroup.invite_code_uuid} className="border-b border-gray-100 text-sm">
                                ...
                                <td className="py-3 px-4">
                                    <ConfirmationModal
                                        confirmationButtonText={t('deleteLink')}
                                        confirmationMessage={t('removeUserGroupConfirm')}
                                        dialogTitle={t('unlinkUserGroup')}
                                        dialogTrigger={
