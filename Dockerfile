...
# Set environment variables for the build (with defaults for local development)
...
ENV NEXT_PUBLIC_LEARNHOUSE_HTTPS=${NEXT_PUBLIC_LEARNHOUSE_HTTPS:-false}
ENV NEXT_PUBLIC_LEARNHOUSE_DEFAULT_ORG=${NEXT_PUBLIC_LEARNHOUSE_DEFAULT_ORG:-default}
ENV NEXT_PUBLIC_LEARNHOUSE_MULTI_ORG=${NEXT_PUBLIC_LEARNHOUSE_MULTI_ORG:-false}
